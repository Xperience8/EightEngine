...
class HUD : public IUserInterface
{
private:
	...
	{
		//UINT newScreenId = std::static_pointer_cast<ChangeMenuScreenEventData>(
		//	pEventData)->GetNewMenuScreenId();
...
public:
	...
	{
		g_EventManager.AddListener(EventListener(this, &HUD::ChangeScreenRequest),
